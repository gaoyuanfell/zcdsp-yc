  ...
  template: `
    <div class="parent">
      <div class="query-tool">
        <div class="left-tool">
          <input-datepicker [isRange]="true" [query]="query" [appendField]="['begin_date','end_date']"
                            (search)="search()"></input-datepicker>
          <yc-checkbox-group [(ngModel)]="recharge_type" [list]="rechargeTypeData" (changeEvent)="search()"
                             [props]="{value:'lookup_code',label:'meaning'}"></yc-checkbox-group>
        </div>
